      ...
      <div className="container mx-auto px-8">
        ...
        >
          {solutions.map((s, index) => {
            ...
            return (
              <ThreeDTilt key={index} className="h-full">
                <motion.div 
                  variants={itemVariants}
                  data-scroll-index={index}
                  ref={setRef(index)}
                  className={`group h-full p-10 transition-all duration-200 rounded-sm border border-gray-50 overflow-hidden relative shadow-sm ${
